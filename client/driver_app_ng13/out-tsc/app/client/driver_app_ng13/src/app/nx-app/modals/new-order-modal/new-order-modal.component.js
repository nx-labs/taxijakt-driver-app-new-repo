...
let NewOrderModalComponent = class NewOrderModalComponent {
    constructor(loadingController, socketService, modalController, orderApi, driverApi, alertController) {
    ...
    doFinishRide() {
        return __awaiter(this, void 0, void 0, function* () {
            alert("DO FINISH RIDE(" + this.orderId + ")");
    ...
    deny() {
        this.orderApi.denyOrder(this.data.orderData.id);
        this.dismiss();
    }
    dismiss() {
...
], NewOrderModalComponent.prototype, "data2", void 0);
__decorate([
    ViewChild(GoogleMapComponent, { static: false }),
    __metadata("design:type", GoogleMapComponent)
], NewOrderModalComponent.prototype, "_GoogleMap", void 0);
NewOrderModalComponent = __decorate([
    Component({
