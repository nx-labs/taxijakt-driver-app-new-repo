...
@Component(
	{
			   selector: 'cm-messenger-status',
			   templateUrl: './cm-messenger-status.component.html',
			   styleUrls: ['./cm-messenger-status.component.scss'],
		   })
export class CmMessengerStatusComponent implements OnInit {
